...
const NewsFilters = ({ filters, onFilterChange }: NewsFiltersProps) => {
  ...
  const hasActiveFilters = filters.category !== 'all' || filters.dateRange !== 'all' || filters.searchQuery !== '';
  ...
  return (
    <div className="w-full lg:w-auto">
      ...
      {/* Filters Container */}
      <div className={`${isFilterOpen || 'lg:block'} ${isFilterOpen ? 'block' : 'hidden'} space-y-4 lg:space-y-0 lg:flex lg:items-center lg:gap-4`}>
        {/* Search Bar */}
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none w-full lg:w-64"
          />
        </div>
