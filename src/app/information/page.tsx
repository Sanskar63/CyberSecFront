  ...
  const categories: Category[] = [
    {
      ...
      description:
        "Protect your personal information and digital identity from cyber threats",
      icon: Shield,
      color: "bg-blue-500",
      detailContent: {
        overview:
    ...
    },
    {
      ...
      title: "Social Media",
      description:
        "Stay safe while connecting with friends and sharing content on social platforms",
      icon: Users,
      color: "bg-purple-500",
      detailContent: {
        overview:
    ...
    },
    {
      ...
      description:
        "Identify and handle misinformation in messaging apps responsibly",
      icon: MessageCircle,
      color: "bg-green-500",
      detailContent: {
        overview:
    ...
    },
    {
      ...
      description:
        "Secure your financial transactions and protect your banking information",
      icon: CreditCard,
      color: "bg-red-500",
      detailContent: {
        overview:
    ...
    },
    {
      ...
      description:
        "Recognize, prevent, and respond to online harassment and bullying",
      icon: UserX,
      color: "bg-orange-500",
      detailContent: {
        overview:
          "Cyberbullying involves using digital platforms to harass, threaten, or embarrass others. Understanding how to recognize and respond to it is essential for online safety.",
        keyThreat: [
    ...
    },
    {
      ...
      description:
        "Keep your digital payments and wallet applications secure from fraud",
      icon: Wallet,
      color: "bg-indigo-500",
      detailContent: {
        overview:
          "Digital wallets offer convenience but require proper security measures to protect against fraud and unauthorized transactions.",
        keyThreat: [
    ...
    },
    {
      ...
      description:
        "Shop safely on the internet and avoid e-commerce scams",
      icon: ShoppingCart,
      color: "bg-pink-500",
      detailContent: {
        overview:
          "Online shopping safety involves identifying legitimate websites, protecting payment information, and avoiding common e-commerce scams.",
        keyThreat: [
    ...
    },
    {
      ...
      description:
        "Maintain cybersecurity standards in professional environments",
      icon: Building,
      color: "bg-teal-500",
      detailContent: {
        overview:
          "Workplace cybersecurity protects both personal and company data. Following security protocols helps maintain a safe digital work environment.",
        keyThreat: [
    ...
    },
    {
      ...
      detailContent: {
        overview:
          "Children face unique online risks. Parents and guardians must actively protect kids while teaching them safe digital habits.",
        keyThreat: [
    ...
    },
    {
      ...
      description:
        "Develop secure daily digital habits and stay updated with security practices",
      icon: Clock,
      color: "bg-gray-500",
      detailContent: {
        overview:
          "Building good daily digital habits and staying updated on security threats is essential for maintaining long-term cybersecurity.",
        keyThreat: [
    ...
    },
    {
      ...
      description:
        "Use health and fitness applications securely while protecting sensitive health data",
      icon: Heart,
      color: "bg-rose-500",
      detailContent: {
        overview:
          "Health and fitness apps collect sensitive personal data. Understanding privacy settings and data sharing is crucial for protecting health information.",
        keyThreat: [
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto">
              Comprehensive guides and best practices for staying safe in the
              digital world
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              Click on any category below to explore detailed information, best
              practices, and security tips
            </p>
          </div>
